        ...
        <div className="flex flex-row w-full rounded-b-md py-2 bg-black">
          <div className="flex flex-row basis-3/12">
            ...
            <div className="bg-white flex text-sm text-left rounded-full border-2 border-purple-700 max-h-[28px]">
              <input type="text" value={newRole} placeholder="New Role" onChange={(e) => setNewRole(e.target.value)}  className="w-[140px] max-h-[28px] outline-0 border-none rounded-full pl-1" />
              <button className="">
          ...
          <div className="flex basis-9/12 self-start min-h-0 min-w-0">
...
/*
self-start cursor-pointer text-sm bg-white rounded-full basis-1/12 border-2 border-purple-700 box-border mb-1 ml-1

NewRoleContain:
min-h-0 min-w-0 focus:border-0 focus:outline-none focus:ring-0 self-start flex flex-row rounded-full bg-white border-2 border-purple-700 basis-1/12 box-border
NewRoleInput
min-h-0 min-w-0 flex text-sm bg-white placeholder:pl-1 rounded-full box-border
